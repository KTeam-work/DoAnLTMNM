  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mainMenu">
      <ul class="navbar-nav mx-auto align-items-lg-center">
        <li class="nav-item"><a class="app-nav-link " href="owner.html">Tổng quan</a></li>
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="app-nav-link active" href="{{ route('owner.services.index') }}">Dịch vụ</a>
        </li>
    ...
    <main class="page-wrap">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <div class="page-desc">
                    Quản lý các dịch vụ và đơn giá áp dụng cho nhà trọ
                </div>
            </div>

            <a
                href="{{ url('/owner/services/create') }}"
                class="btn-brand">
        ...
        <div class="panel service-panel">
            ...
            <div class="service-panel-header">
                ...
                <div>
                    ...
                    <div class="service-panel-description">
                        Các dịch vụ được áp dụng cho nhà trọ này
                    </div>
                ...
                <table class="service-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ url('/owner/services/1/edit') }}"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ url('/owner/services/2/edit') }}"
                                        class="btn-action btn-edit">
                                        ✎ Sửa
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ url('/owner/services/3/edit') }}"
                                        class="btn-action btn-edit">
                                        ✎ Sửa
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ url('/owner/services/4/edit') }}"
                                        class="btn-action btn-edit">
                                        ✎ Sửa
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ url('/owner/services/5/edit') }}"
                                        class="btn-action btn-edit">
                                        ✎ Sửa
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ url('/owner/services/6/edit') }}"
                                        class="btn-action btn-edit">
                                        ✎ Sửa
                                    </a>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="service-description">
                                    Phí sử dụng và bảo trì máy lạnh
                                </div>
                            </td>
                            ...
                            <td>
                                ...
                                <div class="action-group">
                                    ...
                                    <a
                                        href="{{ route('owner.services.edit', ['id' => 7]) }}"
                                        class="btn-action btn-edit">
                                        ✎ Sửa
                                    </a>
